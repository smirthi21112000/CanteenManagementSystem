...
if(isset($_REQUEST['btnSubmit'])) 
	{
		...
		$query = "insert into incredients (product_name,product_id,unit,quantity,price,total) values ('$product_name','$product_id','$unit','$quantity','$price','$total')";
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="product_name" placeholder="Ingredients Name" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<lable>Ingredients ID</lable>
