...
if(isset($_REQUEST['btnSubmit'])) 
	{
		...
		$query = "insert into orders (fname,unit,price,qty,date,username,subtotal,orderid,status) values ('$fname','$unit','$price','$qty','$date','$username','$subtotal','$orderid','Pending')";
