...
$query = "select * from orders where username='$username' AND date='$date'";
                                     ...
                                     <?php while($rec = mysql_fetch_array($data)) { ?>
                                       ...
                                       <tr>
                                        	<td colspan="7" align="right"> Total </td>
                                        	 <td><?php $result = mysql_query("SELECT SUM(subtotal) AS subtotal FROM orders where username='$username' AND date='$date'"); 
