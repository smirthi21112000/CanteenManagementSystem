...
$id = isset($_REQUEST['id']) ? $_REQUEST['id'] : "0";
    if(isset($_REQUEST['btnSubmit'])) 
    {
        ...
        $query1 = "update food set fname='$fname',ftype='$ftype',unit='$unit',price='$price' where id = ".$id;
        if(mysql_query($query1))
        {
        echo '<script language="javascript">';
        echo 'alert("Record Updated!")';
        echo '</script>';
        header('Refresh: 3; URL = view-food.php');
        } 
        else 
        {
        echo '<script language="javascript">';
							...
							<div class="row">
								<div class="col-md-6">
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" name="fname" placeholder="Food Name" required value="<?php echo $rec['fname']; ?>">
										</div>
										<div class="form-group">
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<input type="text" class="form-control" name="price" placeholder="Price" required value="<?php echo $rec['price']; ?>">
										</div>                                 
									</div>
